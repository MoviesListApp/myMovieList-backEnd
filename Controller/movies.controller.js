...
function Movies(title, poster_path, overview, release_dates, comment){
 ...
 const getAllMovies = (request, response)=>{
    axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=${my_api}&language=en-US&page=1`).then(data => {
...
module.exports = {getAllMovies, deleteMovie, AddMovie, updateMovie, getMovie, client};